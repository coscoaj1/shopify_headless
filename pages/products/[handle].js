...
export default function Example({ product, products }) {
  ...
  return (
    <div className="bg-white">
      <div className="pt-4">
        <div className="grid max-w-2xl mx-auto sm:block place-items-center">
          <Image
      ...
      <div className="mx-auto mt-24 max-w-7xl">
        <div className="flex items-center justify-between space-x-4">
          ...
          <Link href="/">
            <a className="text-sm font-medium text-gray-900 whitespace-nowrap hover-text-gray-700">
              View all<span aria-hidden="true">&rarr;</span>
            </a>
          </Link>
        </div>
        <div className="grid grid-cols-1 mt-6 mb-3 place-items-center gap-x-8 gap-y-8 sm:grid-cols-2 lg:grid-cols-4 sm:gap-y-10 lg-grid:cols-4">
